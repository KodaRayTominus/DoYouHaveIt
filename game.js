...
class SceneA extends Phaser.Scene {
    ...
    collide (player, npc, axis){
        if(!this.sys.dialogModal.isVisible()){
            console.log(npc.name);
            var name = npc.getData("name"); 
            getNPCsItem(name);
            var tempText = getDialogText(name);        
        ...
        switch(name){
            ...
            case "jecht":
                if(currentItem === undefined && tradeCount == 0){
                    ...
                    tradeCount++;
                    return "Jecht : 'Thank you so much! I hope it wasn't to much trouble. Here var me give you this HEALING SALVE. It may come in hand later. Its a dangerous world.'";
                } 
                else {
